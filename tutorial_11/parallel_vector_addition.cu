...
__global__ void matrixAddition(double *device_matrixA, double *device_matrixB, double *device_result) {
...
int main() {
    ...
    matrixAddition<<<blocksPerGrid, threadsPerBlock>>>(device_matrixA, device_matrixB, device_result);
    cudaEventRecord(end);
